            ...
            -->
               ...
               <div>
					...
					<select id="kontakt" name="kontakt"> 
						...
						<option value="Mittler">Mittler</option> 
						<option value="Hiller">Hiller</option> 
						<option value="Leffrang">Leffrang</option> 
						<option value="Konnemann">Konnemann</option> 
						<option value="Haefermann">H&auml;fermann</option> 
						<option value="Kensy">Kensy</option> 
						<option value="Beyersdorff">Beyersdorff</option> 
					</select>	
                </div>
                <div>
